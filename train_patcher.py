...
if __name__ == "__main__":
    ...
    if sys.argv[1] == "squad":
        filepath = "out"
        dataset, contexts = load_squad(split='train')
    ...
    for epoch in range(EPOCHS):
        ...
        for row in tqdm.tqdm(dataset):
            ...
            if failure_label != "NO_FAILURE":
                ...
                action = patcher.predict(context, explore=True)
    ...
    dataset.to_pandas().to_csv(f"{filepath}/bandit_train_dataset.csv", sep="\t", index=False)